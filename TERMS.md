# VWAR Loop Life — Terms of Use & Acknowledgment

**Version 1.1**

> **This is not legal advice.** This document was drafted with the help of an AI tool, not a lawyer.
> It is offered honestly and in good faith, but the VWAR Loop Life maintainers are not lawyers and nothing here
...
By installing or using VWAR Loop Life — and by ticking the box on first launch — **you confirm that you have
read, understood, and accept the points below.** If you do not accept them, do not use VWAR Loop Life, and
remove it.

---

## 1. What VWAR Loop Life is — and who provides it

VWAR Loop Life is a free, independent, **non-commercial** application for macOS, Android and iOS that pairs directly
with a WHOOP® strap you own over Bluetooth and stores your data **only on your own device**. There is
no VWAR Loop Life server, no VWAR Loop Life account, and no telemetry — the maintainers cannot see your data and never
receive it.

VWAR Loop Life is published anonymously by an unpaid hobbyist maintainer and contributors, referred to
throughout as **"the maintainers."** No personal identity is asserted or implied. "You" means the
individual or entity using VWAR Loop Life.

## 2. Independent — not affiliated with WHOOP

VWAR Loop Life is an **independent, unofficial project. It is not affiliated with, endorsed by, sponsored by,
or connected to WHOOP, Inc. in any way.** "WHOOP" is a trademark of WHOOP, Inc., used here only
**descriptively (nominative fair use)** to identify the third-party hardware VWAR Loop Life interoperates with —
never to suggest origin, sponsorship, or endorsement, and never as VWAR Loop Life's own brand. All other
trademarks belong to their respective owners.

## 3. Use at your own risk — and the WHOOP Terms of Service

You may use VWAR Loop Life **only with a WHOOP device you own**, to read **your own data.**

**Using VWAR Loop Life may breach WHOOP's Terms of Service.** Whether to use VWAR Loop Life, and any consequences for
your WHOOP account, subscription, device, or warranty, are **your responsibility and your decision
alone.** VWAR Loop Life does not require or encourage you to break any agreement you have entered into; how you
...
You accept that VWAR Loop Life is **experimental software that talks to your device's firmware over an
...
VWAR Loop Life contains **only original work** plus **uncopyrightable factual notes** about how data appears on
the wire, observed by the author from a device the author owns. VWAR Loop Life does **not** contain, bundle,
...
VWAR Loop Life is **not a medical device** and provides **no medical advice.** Heart rate, HRV, recovery,
...
**Do not use VWAR Loop Life to diagnose, treat, monitor, or make any decision about a health condition.** VWAR Loop Life
...
professional**, and seek emergency care for any medical concern — do not rely on VWAR Loop Life.

This covers **every** feature. A few in particular:

- **Mind / mood check-in.** The daily mood check-in, and any correlation VWAR Loop Life draws between your
  ...
  professional or your local emergency service immediately — do not rely on VWAR Loop Life.**
...
- **Apple Health / "Export for Shortcuts" (iOS).** When you export metrics to Apple Health — including
  the HealthKit-free "Export for Shortcuts" path — VWAR Loop Life writes **only** the data you choose, **on your
...
VWAR Loop Life is provided **"as is" and "as available", with no warranty or condition of any kind**, express or
...
any loss or damage arising out of these terms, or out of the use, misuse, or nature of VWAR Loop Life —
...
Because VWAR Loop Life is provided free of charge, on a non-commercial basis, and clearly labelled as
...
that you are using VWAR Loop Life with your own device and your own data, at your own risk, and that you will
not hold the maintainers responsible** to any greater extent than §6 allows. If these terms change
in a way that materially affects your rights, VWAR Loop Life will ask you to acknowledge the new version.
...
anyone's legal rights. VWAR Loop Life exists to let people read their own device's data on their own device;
...
launch (and again if it materially changes). Continuing to use VWAR Loop Life after a change means you accept
the updated terms.
...
*VWAR Loop Life is free, on-device, and independent. Thank you for using it responsibly. See also `LICENSE`
