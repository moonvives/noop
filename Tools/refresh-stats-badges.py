...
Reads counts from the GitHub API (https://api.github.com/repos/moonvives/noop) using the token
...
API="https://api.github.com/repos/moonvives/noop"
...
open_issues=search_count("repo:moonvives/noop is:issue is:open")
resolved=search_count("repo:moonvives/noop is:issue is:closed")
