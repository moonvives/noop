...
final class HealthKitBridge: ObservableObject {
    ...
    private static let quantityReadIds: [HKQuantityTypeIdentifier] = [
        ...
        .respiratoryRate, .bodyTemperature, .stepCount, .walkingRunningDistance,
    ...
    private static let liveQuantityIds: [HKQuantityTypeIdentifier] = [
        ...
        .oxygenSaturation, .bodyTemperature, .stepCount, .walkingRunningDistance, .bloodGlucose
    ]
    ...
    func sync(days: Int = 30) async {
        ...
        await collect(.walkingRunningDistance, unit: .meter(), start: start, end: end, op: .cumulativeSum) { day, v in
