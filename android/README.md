# VWAR Loop Life — Android

An **offline WHOOP companion** for Android. VWAR Loop Life connects directly to a WHOOP 4.0
...
```
android/
├── settings.gradle.kts          # rootProject "VWAR Loop Life", includes :app
...
VWAR Loop Life requests only what BLE needs, and deliberately omits `INTERNET`:
...
- [ ] Dark VWAR Loop Life theme renders (surfaceBase `#060A08`, accent `#18C98B`); no white flash on launch.
