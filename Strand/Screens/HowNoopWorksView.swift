...
// MARK: - How VWAR Loop Life works (primer)
//
...
struct HowNoopWorksView: View {
    ...
    private enum Section: CaseIterable, Identifiable {
        ...
        var body: String {
            switch self {
            case .sleepSorting:
                return String(localized: "VWAR Loop Life picks your main sleep as your longest real block, and (once it has learned your usual hours) the one nearest your normal sleep time. Everything else that day is a nap. You can always edit bed and wake times.")
            case .scores:
            ...
            case .recording:
                return String(localized: "When your strap is connected VWAR Loop Life is saving data live. \"Last synced\" tells you how fresh it is. If it says \"Not recording\", reconnect.")
            case .provenance:
                return String(localized: "A badge shows whether a number was scored on-device by VWAR Loop Life, or imported from Whoop or Apple Health.")
            }
        }
    ...
    private var header: some View {
        HStack(spacing: 12) {
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("How VWAR Loop Life works").font(StrandFont.rounded(26, weight: .bold))
        ...
        NoopCard {
            VStack(alignment: .leading, spacing: 14) {
                Text("THE ONE RULE").font(StrandFont.overline)
                    .tracking(StrandFont.overlineTracking)
                    .foregroundStyle(StrandPalette.textSecondary)
                Text("VWAR Loop Life never shows you a number it had to make up. If a score isn't ready, it tells you why and what to do next. Everything here runs on your device, from your strap.")
    ...
    private var footerNote: some View {
        Text("VWAR Loop Life never makes up a number. When it can't compute one honestly it tells you what's missing and what to do, rather than showing a fake value.")
            .font(StrandFont.footnote)
            .foregroundStyle(StrandPalette.textTertiary)
            .fixedSize(horizontal: false, vertical: true)
            .frame(maxWidth: .infinity, alignment: .leading)
...
#if DEBUG
#Preview("How VWAR Loop Life works") {
